...
public class AdaptadorAdminJornadas extends BaseAdapter {
    ...
    public  AdaptadorAdminJornadas(Context contextS, List<jornadas> objetos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView= flater.inflate(R.layout.item_jornada_admin, null);
