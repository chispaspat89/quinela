...
public class AdaptadorPuntos extends BaseAdapter {
    ...
    public  AdaptadorPuntos(Context contextS, List<jornadas> objetos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView= flater.inflate(R.layout.item_bonus, null);
