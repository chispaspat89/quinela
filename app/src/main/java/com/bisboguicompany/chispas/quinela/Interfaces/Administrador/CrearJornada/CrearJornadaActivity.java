...
public class CrearJornadaActivity extends DaggerAppCompatActivity {
    ...
    @Inject
    CrearJornadaPresenter mTasksPresenter;


    @Inject
    Lazy<CrearJornadaFragment> taskFragmentProvider;
    ...
    @Inject
    CrearJornadaFragment fragment;

    CrearJornadaFragment taskDetailFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crear_jornada);


        taskDetailFragment = (CrearJornadaFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
