...
public class PuntosActivity  extends DaggerAppCompatActivity implements HasFragmentInjector {
    ...
    @Inject
    PuntosPresenter mTasksPresenter;


    @Inject
    Lazy<PuntosFragment> taskFragmentProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PuntosFragment tasksFragment =
                (PuntosFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.itementrada:
                                Intent ad =  new Intent(PuntosActivity.this, AdminActivity.class);
                                startActivity(ad);

                                break;
                            case R.id.itemeditar:

                                Intent resultados =  new Intent(PuntosActivity.this, ResultadosAdminActivity.class);
                                startActivity(resultados);

                                break;

                            case R.id.itemvendedor:
                                Intent vende =  new Intent(PuntosActivity.this, ListVendedoresActivity.class);
                                startActivity(vende);
                                break;
    ...
    public void CerrarSesion(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PuntosActivity.this);
