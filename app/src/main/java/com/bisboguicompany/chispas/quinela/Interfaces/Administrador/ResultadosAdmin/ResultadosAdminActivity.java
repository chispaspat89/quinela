...
public class ResultadosAdminActivity  extends DaggerAppCompatActivity implements HasFragmentInjector {
    ...
    @Inject
    ResultadosAdminPresenter mTasksPresenter;


    @Inject
    Lazy<ResultadosAdminFragment> taskFragmentProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_admin);



        ActionBar ab = getSupportActionBar();
        ab.setTitle("Resultados x Jornada");
        ...
        ResultadosAdminFragment tasksFragment =
                (ResultadosAdminFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.itementrada:
                                ...
                                Intent princi =  new Intent(ResultadosAdminActivity.this, AdminActivity.class);
                            ...
                            case R.id.itemvendedor:
                                Intent vende =  new Intent(ResultadosAdminActivity.this, ListVendedoresActivity.class);
                                startActivity(vende);
                                break;

                            case R.id.itemPuntos:
                                Intent puntos =  new Intent(ResultadosAdminActivity.this, PuntosActivity.class);
    ...
    public void CerrarSesion(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ResultadosAdminActivity.this);
