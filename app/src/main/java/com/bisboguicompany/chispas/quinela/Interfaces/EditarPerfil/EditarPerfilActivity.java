...
public class EditarPerfilActivity  extends DaggerAppCompatActivity implements HasFragmentInjector {
    ...
    @Inject
    EditarPerfilPresenter mTasksPresenter;


    @Inject
    Lazy<EditarPerfilFragment> taskFragmentProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditarPerfilFragment tasksFragment =
                (EditarPerfilFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.itementrada:
                                ...
                                Intent edit = new Intent(EditarPerfilActivity.this, PrincipalActivity.class);
                                startActivity(edit);
                                break;
