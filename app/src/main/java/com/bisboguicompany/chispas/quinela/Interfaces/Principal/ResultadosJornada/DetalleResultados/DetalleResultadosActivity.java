...
public class DetalleResultadosActivity  extends DaggerAppCompatActivity {
    ...
    @Inject
    DetalleResultadosPresenter mTasksPresenter;


    @Inject
    Lazy<DetalleResultadosFragment> taskFragmentProvider;
    ...
    @Inject
    DetalleResultadosFragment fragment;

    DetalleResultadosFragment taskDetailFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskDetailFragment = (DetalleResultadosFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
