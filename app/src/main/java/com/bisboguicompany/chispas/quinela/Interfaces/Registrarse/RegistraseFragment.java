...
@ActivityScoped
public class RegistraseFragment extends DaggerFragment implements RegistraseContract.View, View.OnClickListener {

    public static RegistraseActivity mactivity;



    @Inject
    RegistraseContract.Presenter mPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mactivity = (RegistraseActivity) getActivity();
        aa.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        mactivity.onFragmentInteraction("Registro");





        View v= inflater.inflate(R.layout.fragment_registrase, container, false);
    ...
    public void mensajeError(String mensaje){
        ...
        if (mdialogBuilder == null) {
            ...
            mdialogBuilder.setTitle("Registro");
