...
public class PerfilVendedorActivity extends DaggerAppCompatActivity implements HasFragmentInjector {
    ...
    @Inject
    PerfilVendedorPresenter mTasksPresenter;


    @Inject
    Lazy<PerfilVendedorFragment> taskFragmentProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PerfilVendedorFragment tasksFragment =
                (PerfilVendedorFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.itementrada:
                                ...
                                Intent edit = new Intent(PerfilVendedorActivity.this, VentasActivity.class);
                                startActivity(edit);
                                break;
    ...
    public void CerrarSesion(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PerfilVendedorActivity.this);
