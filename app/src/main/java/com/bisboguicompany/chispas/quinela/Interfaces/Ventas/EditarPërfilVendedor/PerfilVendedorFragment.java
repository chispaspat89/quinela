 ...
 */
public class PerfilVendedorFragment  extends DaggerFragment implements PerfilVendedorContract.View,View.OnClickListener {


    public static PerfilVendedorActivity mactivity;
    Button btnRegistro;
    ...
    @Inject
    PerfilVendedorContract.Presenter mPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mactivity = (PerfilVendedorActivity) getActivity();
        aa.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);


        View v=  inflater.inflate(R.layout.fragment_perfil_vendedor, container, false);

        final View hView    = PerfilVendedorActivity.navigationView.getHeaderView(0);
