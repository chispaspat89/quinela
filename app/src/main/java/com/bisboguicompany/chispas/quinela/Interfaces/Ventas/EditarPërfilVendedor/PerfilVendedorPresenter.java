...
public class PerfilVendedorPresenter implements PerfilVendedorContract.Presenter {


    private final RepositoryUsuario mTasksRepository;

    @Nullable
    private PerfilVendedorContract.View mTasksView;


    @Inject
    PerfilVendedorPresenter(RepositoryUsuario tasksRepository) {
    ...
    @Override
    public void takeView(PerfilVendedorContract.View view) {
