...
public class VentasActivity extends DaggerAppCompatActivity implements HasFragmentInjector {
    ...
    @Inject
    VentasPresenter mTasksPresenter;


    @Inject
    Lazy<VentasFragment> taskFragmentProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VentasFragment tasksFragment =
                (VentasFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.itemeditar:
                                ...
                                Intent edit = new Intent(VentasActivity.this, PerfilVendedorActivity.class);
                                startActivity(edit);
                                break;
